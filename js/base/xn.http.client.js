;(function (XN, win) {
	...
	XN.namespace("XN.HttpClient", function () {
     ...
     */
	XN.HttpClient.prototype.request = function (options) {
		var This = this;
            ...
            if (xhr.readyState == 4 && xhr.status != 0) {//abort()后xhr.status为0
                ...
                if (_status == 304 || (_status >= 200 && _status < 300)) {
                    ...
                    if (headers && headers["Date"]) {
                        ...
                        XN._ServerTime_ = servreTime;
                        XN._ClientDiffTime_ = new Date() - servreTime;
                    }
	...
	XN.HttpClient.prototype.abort = function (options) {
        this.xhr.abort();
        this.onAbort();
        return this;
    };

	XN.HttpClient.prototype.utilCreateXHR = function (options) {
	...
	XN.HttpClient.prototype.utilSetHttpHeaders = function (headers, xhr) {
		if (headers) {
	...
	XN.HttpClient.prototype.utilGetHttpHeaders = function (xhr) {
	...
	XN.HttpClient.prototype.onResponse = function(info) {

	};

	XN.HttpClient.prototype.onError = function (e) {
		
	};

	XN.HttpClient.prototype.onTimeout = function (e) {
